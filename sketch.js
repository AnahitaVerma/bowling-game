...
function setup() {
 ...
 // bowlingball.scale = 0.5;
  ...
  pin1 = new Pins(620, 70, 30, 60)
  pin2 = new Pins(640, 70, 30, 60)

  pin3 = new Pins(640, 70, 30, 60)
  pin4 = new Pins(680, 70, 30, 60)
  pin5 = new Pins(635, 130, 30, 60)
  pin6 = new Pins(645, 130, 30, 60)
  pin7 = new Pins(655, 130, 30, 60)
  pin8 = new Pins(640, 210, 30, 60)
  pin9 = new Pins(650, 210, 30, 60)
  pin10 = new Pins(645, 250, 30, 60)
